...
function useFormZodError(zodObject, state) {
    var _a = (0, react_1.useState)(), zodError = _a[0], setZodError = _a[1];
    var _b = (0, react_1.useState)(false), startValidation = _b[0], setStartValidation = _b[1];
    ...
    var runZodValidation = (0, react_1.useCallback)(function () {
